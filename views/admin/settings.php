    ...
    <table class="form-table">
      ...
      <tr>
        ...
        <td>
          ...
          <p><?php echo _('meta keywordsのデフォルト値に使われます。'); ?></p>
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
          ...
          <textarea name="" id="" cols="30" rows="2"></textarea>
          <p><?php echo _('meta description, og:description, twitter:descriptionのデフォルト値に使われます。'); ?></p>
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
          ...
          <p><?php echo _('og:image, twitter:imageのデフォルト値に使われます。'); ?></p>
        </td>
      </tr>
      </tbody>
    </table>
